package com.uni.handlerAdapter;


import com.uni.annotation.SfService;
import com.uni.argumentResolver.ArgumentResolver;
...
@SfService("SfHandlerAdapter")
public class SfHandlerAdapter implements HandlerAdapterService {
    //对method方法里的参数进行处理
